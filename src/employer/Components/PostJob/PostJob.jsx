                ...
                <div className='job-details-container-card'>
                    <div className='job-title-type-container'>
                        <div className='job-title-div'>
                            ...
                            <input required className='job-title-input' value={jobTitle} type='text'
                                   onChange={(e) => setJobTitle(e.target.value)}></input>
                        </div>
                        <div className='job-type-div'>
                            <label className='job-type-label'>Job Type</label>
                            <select className="select" id="job-type-input" value={jobType}
                    ...
                    <div className='job-salery-date-container'>
                        <div className='job-salary-div'>
                            <label className='job-salery-label'>Salary</label>
                            <input className='job-salery-input' value={jobSalery} type='text'
                                   onChange={(e) => setjobSalery(e.target.value)}></input>
                        </div>
                    </div>
                    ...
                    <div className='job-salery-date-container' style={{marginRight: '0'}}>
                        <div className='job-industry-div'>
                            ...
                            <input className='job-salery-input' value={jobindustry} type='text'
                                   onChange={(e) => setjobIndustry(e.target.value)}></input>
                        </div>
                    </div>
                    <div className='job-salery-date-container'>
                        <div className='job-location-div'>
                            <label className='job-salery-label'>Location</label>
                            <input className='job-salery-input' value={jobLocation} type='text'
                                   onChange={(e) => setjobLocation(e.target.value)}></input>
                        </div>
                    </div>
                    ...
                    <div className='job-description-div'>
                        ...
                        <textarea className='job-description-input' value={jobDescription} type='text'
